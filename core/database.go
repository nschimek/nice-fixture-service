...
type Database interface {
	...
	InnerJoin(joinTable string, where interface{}, dest interface{}) DatabaseResult
}
...
func (db *database) InnerJoin(joinTable string, where interface{}, dest interface{}) DatabaseResult {
	if where != nil {
