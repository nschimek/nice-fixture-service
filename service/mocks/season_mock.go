...
func (_m *Season) GetAll() ([]model.Season, *rest_error.Error) {
	ret := _m.Called()

	var r0 []model.Season
	var r1 *rest_error.Error
	if rf, ok := ret.Get(0).(func() ([]model.Season, *rest_error.Error)); ok {
		return rf()
	}
	...
	if rf, ok := ret.Get(1).(func() *rest_error.Error); ok {
		r1 = rf()
	} else {
		if ret.Get(1) != nil {
...
func (_c *Season_GetAll_Call) Return(_a0 []model.Season, _a1 *rest_error.Error) *Season_GetAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Season_GetAll_Call) RunAndReturn(run func() ([]model.Season, *rest_error.Error)) *Season_GetAll_Call {
	_c.Call.Return(run)
	return _c
}
